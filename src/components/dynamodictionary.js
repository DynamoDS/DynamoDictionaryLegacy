...
function createNewKey(ind) {
    if (!userOb[ind]) {
        userOb[ind] = {}
    }
}
function addCurrentImage(ind){
    userOb[ind].image = {}
}
...
function imgLoadSubmit() {
    ...
    createNewKey(hitob.index);
    console.log(newic)
    if (newic != undefined) {
        userOb[hitob.index]
        console.log(eOb[hitob.index][ipindex]["imageFile"] )
    ...
    function updateInfo(ob) {
        ...
        if (hit == true) {
            ...
            function addExamp(z, v, stock) {
                ...
                console.log('eob',eOb)
                console.log(eOb[hitob.index],v,hitob.index)
                if (eOb[hitob.index][v] != undefined) {
                    console.log(tempFiles,'trucking')
                    // if(tempFiles[hitob.index]&&tempFiles[hitob.index].image){
                    //     console.log(tempFiles[hitob.index].image)
                    // }
                    // else{
