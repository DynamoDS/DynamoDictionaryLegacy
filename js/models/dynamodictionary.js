...
require(["d3"], function (d3) {
    ...
    $j("#submitPR").on("click", function(){
        

        
        
  var SM = new SimpleModal({"btn_ok":"Submit Pull Request"});
        console.log(SM)
...
//    
//    
    d3.select("#submitPR").style("opacity", 0)
        ...
        d3.json("data/Dynamo_Nodes_Documentation.json", function (data) {
            ...
            if (hit == true) {
                ...
                d3.select(".inDepth").html("<hr><b><br>In Depth:</b>&nbsp&nbsp&nbsp")
                    .append("img").attr("hspace", 2).attr("width", "20px").attr("src", iconimage2).style("opacity", .25).attr('id', 'editButton')
                    .each(function () {
                        editAttributes()
                    })
                    .on("mouseover", function () {
                ...
                d3.select(".exampleFile")
                    ...
                    .on("click", function () {
                        ...
                        var linker = $j('<a href="' + dl + '" id="dl" download></a>').appendTo('body').click();
...
//                    d3.select(".exampleFile")
//                    .append("img").attr("hspace", 1).attr("width", "80%").attr("src", iconimage4)
